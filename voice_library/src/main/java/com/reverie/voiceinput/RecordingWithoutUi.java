...
class RecordingWithoutUi {
     ...
     */
    RecordingWithoutUi(Context context, String apiKey, String appId, String domain, String lang, String logging,double noInputTimeout,double silence,double timeout) {
